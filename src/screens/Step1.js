          ...
          <View style={[styles.container, styles.step1]}>
            ...
            <View style={styles.formItem}>
              ...
              <TextInput
                ...
                // value={this.state.text}
                placeholder={
                  'Tea trade Wharf, 26 shad Thames, London, United Kingdom is a laxury real estate listing for sale by Mansion Global.'
                }
                placeholderTextColor="#000"
              />
            </View>
