      ...
      <TouchableOpacity
        ...
        <View
          style={[
            ...
            {
              backgroundColor:
                item.unReadCount > 0 ? '#fff5e1' : 'transaparent',
            },
          ]}>
          <View>
            ...
            <Icon
              name="ellipse"
              style={
                item.livestatus == 'active' ? styles.online : styles.offline
              }
            />
          </View>
          ...
          <View style={styles.rightContent}>
            ...
            <Text style={styles.msgTime}>
              {item.lastMessageCreationTime &&
                Moment.unix(parseInt(item.lastMessageCreationTime)).fromNow()}
            </Text>
          </View>
        </View>
      </TouchableOpacity>
  ...
  const Indepths = ({item, onPress, style}) => (
    <TouchableOpacity
      ...
      <View
        style={[
          styles.chatWrap,
          {backgroundColor: item.unReadCount > 0 ? '#fff5e1' : 'transaparent'},
        ]}>
        <View>
          <Image
            source={{
          ...
          <Icon
            name="ellipse"
            style={item.livestatus == 'active' ? styles.online : styles.offline}
          />
        </View>
        <View style={styles.contactInfo}>
          <Text
