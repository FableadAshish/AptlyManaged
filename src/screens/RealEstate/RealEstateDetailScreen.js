    ...
    return (
      <View>
        <KeyboardAvoidingView enabled>
          <ImageBackground source={Images.EstateDetail} style={styles.headerBG}>
          ...
          <View style={styles.agentInfoWrap}>
            ...
            <TouchableOpacity
              ...
              <View style={styles.agentInfo}>
                <Image source={Images.PhoneWithBg} style={styles.contactIcon} />
            ...
            <TouchableOpacity
              ...
              <View style={styles.agentInfo}>
                <Image source={Images.MailWithBg} style={styles.contactIcon} />
          ...
          <View style={styles.mainContent}>
            ...
            <View
              ...
              <View style={{flexDirection: 'row'}}>
                ...
                <Text style={{fontSize: 14}}> {data.availability}</Text>
              </View>
              <View
                style={{
            ...
            <View style={styles.baseInfoWrap}>
              <View style={styles.baseInfo}>
                <Text style={styles.value}>
                  <Image source={Images.Bed} style={styles.bedIcon} />{' '}
                  {data.beds}
                </Text>
              ...
              <View style={styles.baseInfo}>
                <Text style={styles.value}>
                  <Image source={Images.Bath} style={styles.bathIcon} />{' '}
                  {data.baths}
                </Text>
              ...
              <View style={styles.baseInfo}>
                <View style={styles.valueWrap}>
                  <Text style={styles.value}>
                    <Image source={Images.Lease} style={styles.leaseIcon} />{' '}
                    {leaseNum}
                  </Text>
            ...
            {faci.length != 0 && (
              <Image source={Images.LineShape} style={styles.linePatern} />
            )}
            {faci.length ? (
