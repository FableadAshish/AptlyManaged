          ...
          <View style={styles.roudedLayout}>
            <View style={styles.container}>
              ...
              <Text style={styles.ParaText}>
                ...
                the use of Aptly Managed's Website, located at
                www.aptlymanaged.com.
              </Text>
              <Text style={styles.ParaText}>
                By accessing this website we assume you accept these terms and
                conditions. Do not continue to use Aptly Managed if you do not
              ...
              <Text style={styles.ParaText}>
                We employ the use of cookies. By accessing Aptly Managed, you
                agreed to use cookies in agreement with the Aptly Manageds
                Privacy Policy.
              </Text>
              <Text style={styles.ParaText}>
                ...
                affiliate/advertising partners may also use cookies. Have a look
                at our Cookie Policy in more detail.
              </Text>
              <Text style={styles.ParaTitle}>License</Text>
              <Text style={styles.ParaText}>
                Unless otherwise stated, Aptly Managed and/or its licensors own
                the intellectual property rights for all material on Aptly
                Managed. All intellectual property rights are reserved. You may
                access this from Aptly Managed for your own personal use
                subjected to restrictions set in these terms and conditions. Our
                Terms and Conditions were created with the help of the WebTerms
              ...
              <View style={styles.NoteListWrap}>
                <Text style={styles.NoteList}>
                  • Republish material from Aptly Managed
                </Text>
                <Text style={styles.NoteList}>
                  • Sell, rent or sub-license material from Aptly Managed
                </Text>
                <Text style={styles.NoteList}>
                  • Reproduce, duplicate or copy material from Aptly Managed
                </Text>
                <Text style={styles.NoteList}>
                  • Redistribute content from Aptly Managed
                </Text>
              </View>
              <Text style={styles.ParaText}>
              ...
              <Text style={styles.ParaText}>
                Aptly Managed reserves the right to monitor all Comments and to
              ...
              <Text style={styles.ParaText}>
                You hereby grant Aptly Managed a non-exclusive license to use,
              ...
              <View style={styles.NoteListWrap}>
                ...
                <Text style={styles.NoteList}>
                  ...
                  nonprofit organizations, charity shopping malls, and charity
              ...
              <Text style={styles.ParaText}>
                ...
                of Aptly Managed; and (d) the link is in the context of general
                resource information. These organizations may link to our home
                page so long as the link: (a) is not in any way deceptive; (b)
                does not falsely implysponsorship, endorsement or approval of
              ...
              <Text style={styles.ParaText}>
                ...
                by sending an e-mail to Aptly Managed. Please include your name,
              ...
              <Text style={styles.ParaText}>
                No use of Aptly Managed's logo or other artwork will be allowed
              ...
              <Text style={styles.ParaText}>
                ...
                However, Aptly Managed cannot warranty the expressions and
                suggestions of the contents, as well as its accuracy. In
                addition, to the extent permitted by the law, Aptly Managed
                shall not be responsible for any losses and/or damages due to
                the usage of the information on our website. Our Disclaimer was
                generated with the help of the WebTerms Disclaimer Generator
              </Text>
              <Text style={styles.ParaText}>
              ...
              <Text style={styles.ParaText}>
                ...
                which are provided for convenience only. Any information or
                statements that appeared in these sites are not sponsored,
                endorsed, or otherwise approved by Aptly Managed. For these
                external sites, Aptly Managed cannot be held liable for the
                availability of, or the content located on or through it. Plus,
                any losses or damages occurred from using these contents or
                theinternet generally.
              </Text>
            </View>
          </View>
